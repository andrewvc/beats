...
type ValueValidator func(path string, v interface{}) *Results
...
func (id IsDef) check(path string, v interface{}, keyExists bool) *Results {
...
func ValidResult(path string) *Results {
...
func KeyMissingResult(path string) *Results {
...
func StrictFailureResult(path string) *Results {
